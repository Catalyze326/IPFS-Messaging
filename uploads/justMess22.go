		...
		if r.Method == "GET" {
	      ...
	      fmt.Fprintf(w, "subscribed!")
				...
				//username = "<font color='darkred'>" + username + "</font>"
				 ...
				 //username + "<font color='white'>" + ": " + string(p.Body) + "</font><br>"

				WriteStringToFile("messaging.txt", username + "<font color='white'>" + ": has joined </font><br>")
				//WriteStringToFile("messaging.txt", username + "<font color='black'>" + ": has joined </font><br>")
...
func saveHandler(w http.ResponseWriter, r *http.Request) {
    ...
    err7 := p.save() //where it saves the new text as p.Body
		...
		message = username + "<font color='white'>" + ": " + string(p.Body) + "</font><br>"
